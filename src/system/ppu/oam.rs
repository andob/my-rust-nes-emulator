...
impl PPUOAM
{
    ...
    pub fn get_background_sprites(&self) -> Vec<PPUOAMSpriteDescriptor>
    {
        return self.get_sprites(|flags| ((flags & 0b00100000) >> 5) == 1);
    }

    pub fn get_foreground_sprites(&self) -> Vec<PPUOAMSpriteDescriptor>
    {
        return self.get_sprites(|flags| ((flags & 0b00100000) >> 5) == 0);
    }

    fn get_sprites(&self, flags_filter : fn(byte) -> bool) -> Vec<PPUOAMSpriteDescriptor>
    {
        ...
        for index in (0..self.bytes.len()).step_by(4)
        {
            ...
            if flags_filter(flags)
            {
                ...
                sprites.push(PPUOAMSpriteDescriptor
                {
                    ...
                    pattern_table_index: (pattern_table_data & 0b11111110) as address,
